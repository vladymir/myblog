...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('posts_post', 'title', self.gf('django.db.models.fields.TextField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Post.title'
        db.alter_column('posts_post', 'title', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        'posts.post': {
            ...
            'title': ('django.db.models.fields.TextField', [], {'max_length': '500'})
        },
        'posts.tag': {
